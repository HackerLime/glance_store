...
const DevicePageHeader = ({ breadCrumb, backText }) => {
	return (
		<div style={{ margin: '0 0 40px 0' }}>
			<div className='d-flex align-items-center' style={{ margin: '0 0 32px 0' }}><Link style={{ textDecoration: 'none', color: '#ABABAB', fontSize: '16' }} to={SHOP_ROUTE}>Главная /</Link><h2 style={{ fontSize: 14, lineHeight: '19px', color: '#838383' }}>{breadCrumb}</h2></div>
